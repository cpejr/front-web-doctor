...
export const EnviandoArquivo = (base64) =>
  api.post("/arquivofile", { file: base64 });
...
export const finalizarPDF = (extensiondata) =>
  api.post("/finalizar", extensiondata);
...
export const requisicaoComentario = () => api.get(`/comentarios`);
...
export const requisicaoIndicacaoEspecifica = () =>
  api.get(`/indicacoes_especificas/`);

export const requisicaoMedicosIndicados = (id_indicacao_especifica) =>
  api.get(`/medicos_indicados/${id_indicacao_especifica}`);

export const indicarMedico = (
  id_indicacao_especifica,
  nome,
  telefone,
  local_atendimento
) =>
  api.post(`/medicos_indicados`, {
    id_indicacao_especifica,
    nome,
    telefone,
    local_atendimento,
...
export const alterarMedicoIndicado = (id, estado) =>
  api.put(`/medicos_indicados/${id}`, estado);

export const deletarMedicoIndicado = (id) =>
  api.delete(`/medicos_indicados/${id}`);
...
export const enviarMensagemDeConfirmarPagamento = (id_usuario, Secretaria) =>
...
export const deletarConversa = (id) => api.delete(`/conversas/${id}`);

export const criarMensagem = (mensagem) => api.post(`/mensagems`, mensagem);

export const criarMensagemComArquivo = (mensagem) =>
  api.post(`/mensagemsfile`, mensagem);
...
export const requisicaoHomes = () => api.get(`/homes`);

export const TokenById = (id_usuario) =>
  api.get(`/token_usuarios/${id_usuario}`);
...
export const requisicaoSobreMimDados = () => api.get("/sobremims");
...
export const requisicaoCarrossel = () => api.get(`/imagem_carrossels/`);
