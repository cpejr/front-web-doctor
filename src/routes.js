...
import EdicaoIndicacoesESugestoesWeb from './pages/EdicaoIndicacoesESugestoesWeb';
  ...
  return (
    <Header>
      <Switch>
        ...
        <RotasPrivadas
          exact
          path='/web/edicaoindicacoesesugestoesweb'
          component={EdicaoIndicacoesESugestoesWeb}
        />
